...
app.get('/ok/:msg', function(req, res) {
    const msgOk = {
        logmsg: req.params.msg
    } 
    res.render('painel', {msgvalide: logmsg});
});
app.get('/ret/:msg', function(req, res) {
    
    const msgRet = req.params.msg
 
    //console.log(logerro.erro)
    res.render('painel', {msgvalide: msgRet});
});
/*
app.get('/erro/:erro', function(req, res) {
    const erro = res.params.erro;
    res.render('painelvalide', {log: erro});
});
*/
